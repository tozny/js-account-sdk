...
class AccountBillingStatus {
    constructor(accountActive, isTrial, trialPeriodEnds, isLegacy, isGoodStanding = null, isFree = null) {
     ...
     */
    static decode(json) {
        return new AccountBillingStatus(json.account_active, json.is_trial, json.trial_period_ends, json.is_legacy, json.is_good_standing, json.is_free);
    }
}

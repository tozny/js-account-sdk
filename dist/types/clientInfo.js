 ...
 */
class ClientInfo {
    constructor(clientId, name, type, enabled, hasBackup, publicKey, signingKey, apiKeyId) {
     ...
     */
    static decode(json) {
        return new ClientInfo(json.client_id, json.name, json.type, json.enabled, json.has_backup, json.public_key, json.signing_key, json.api_key_id, json.api_secret_key);
    }
}

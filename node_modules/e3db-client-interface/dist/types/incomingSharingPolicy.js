...
var IncomingSharingPolicy =
/*#__PURE__*/
function () {
  function IncomingSharingPolicy(writerId, recordType) {
    var writerName = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    (0, _classCallCheck2["default"])(this, IncomingSharingPolicy);
  ...
  (0, _createClass2["default"])(IncomingSharingPolicy, null, [{
    key: "decode",
    value: function () {
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", Promise.resolve(new IncomingSharingPolicy(json.writer_id, json.record_type, json.writer_name)));
  ...
  return IncomingSharingPolicy;
}();

exports["default"] = IncomingSharingPolicy;